...
/// <summary>
/// Framework-neutral dashboard navigation source shared by MVC and Blazor shells.
/// </summary>
public static class DashboardNavigationCatalog
{
    ...
    public static DashboardNavigationViewModel Build(string? currentPath)
    {
        var normalizedPath = Normalize(currentPath);
        var nodes = Navigation.Select(item => BuildNode(item, normalizedPath, 0)).ToArray();
